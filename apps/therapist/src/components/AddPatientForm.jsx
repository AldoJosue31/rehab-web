// AddPatientForm.jsx (si ya lo tienes, déjalo; en caso de que necesites copiar)
...
export default function AddPatientForm({ onSubmit = () => {}, onCancel = () => {}, busy = false, error = "" }) {
  ...
  return (
    <div>
      <h3 className="text-lg md:text-2xl font-semibold mb-2">Añadir paciente</h3>
      <div className="bg-white rounded-xl p-6 shadow-sm border max-w-2xl">
        <form onSubmit={(e) => { e.preventDefault(); onSubmit({ nombre, telefono, tutor, nivel }); }} className="space-y-4">
          <div>
