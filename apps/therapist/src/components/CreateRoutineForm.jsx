...
export default function CreateRoutineForm({ onSubmit = () => {}, onCancel = () => {}, busy = false, error = "", exercises = [] }) {
  ...
  return (
    <div>
      <h3 className="text-lg md:text-2xl font-semibold mb-2">Crear rutina</h3>
      <div className="bg-white rounded-xl p-6 shadow-sm border max-w-3xl">
        <form onSubmit={(e) => { e.preventDefault(); onSubmit({ nombre, sesiones: sesionesN, duracion, descripcion: recomendaciones, ejercicios: selectedEj }); }} className="space-y-4">
          <div>
